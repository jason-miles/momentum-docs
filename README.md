...
- ⚡ [**Lakehouse :: RT**](#-lakehouse--rt) — Lakehouse real-time processing `(1)`
- 🧩 [**Omnigent**](#-omnigent) — Omnigent meta-harness for AI agents `(2)`
- 📐 [**Semantic-Modelling**](#-semantic-modelling) — UC Metric Views and semantic layer modeling `(5)`
- 📚 [**Unity Catalogue**](#-unity-catalogue) — Unity Catalog design, best practices, and governance `(5)`
- 📣 [**_DAIS 2026 announcements**](#-dais-2026-announcements) — Data + AI Summit 2026 announcements `(1)`

---

## 🤖 AI Agents

> State-of-the-art agent research and industry reports
...
| # | Document | Type |
|---|---|---|
| 1 | 📄 [Databricks-Big-Book-Of-GenAI-FINAL.pdf](GenAI%20/Databricks-Big-Book-Of-GenAI-FINAL.pdf) | `PDF` |
...
> Genie rollout, migration, and enterprise deployment guides
...
*Maintained as a shareable reference library — documents are grouped by topic. Click any title to open the file.*
